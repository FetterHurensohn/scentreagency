...
const CallToAction = ({ slice }: CallToActionProps): JSX.Element => {
  return (
    <Bounded
      ...
      className="relative textpy-32 text-center font-medium md:py-40"
    >
      <div className="glow absolute -z-10 aspect-square w-full max-w-sm rounded-full bg-purple-500/50 blur-[160px] filter" />
