 ...
 * Item in *Page → UID*
 */
export interface PageDocumentDataUid2Item {}
...
interface SettingsDocumentData {
  ...
  /**
   * Mate Description field in *Settings*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: settings.mate_description
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  mate_description: prismic.KeyTextField;
...
/**
 * Item in *Bento → Default → Primary → Box 1*
 */
export interface BentoSliceDefaultPrimaryBox1Item {
  /**
   * Title field in *Bento → Default → Primary → Box 1*
   *
   * - **Field Type**: Title
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.box_1[].title
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  title: prismic.TitleField;

  /**
   * Body field in *Bento → Default → Primary → Box 1*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.box_1[].body
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  body: prismic.RichTextField;

  /**
   * Image field in *Bento → Default → Primary → Box 1*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.box_1[].image
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  image: prismic.ImageField<never>;

  /**
   * Wide field in *Bento → Default → Primary → Box 1*
   *
   * - **Field Type**: Boolean
   * - **Placeholder**: *None*
   * - **Default Value**: false
   * - **API ID Path**: bento.default.primary.box_1[].wide
   * - **Documentation**: https://prismic.io/docs/field#boolean
   */
...
export interface BentoSliceDefaultPrimary {
   ...
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: italc for gold text
  ...
  /**
   * Box 1 field in *Bento → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.box_1[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  box_1: prismic.GroupField<Simplify<BentoSliceDefaultPrimaryBox1Item>>;
}
...
/**
 * Item in *Integrations → Default → Primary → nahbro*
 */
export interface IntegrationsSliceDefaultPrimaryNahbroItem {
  /**
   * Icon field in *Integrations → Default → Primary → nahbro*
   *
   * - **Field Type**: Select
   * - **Placeholder**: *None*
   * - **API ID Path**: integrations.default.primary.nahbro[].icon
   * - **Documentation**: https://prismic.io/docs/field#select
   */
  icon: prismic.SelectField<
    'Instagram' | 'Npm' | 'Figma' | 'Webflow' | 'Github' | 'TikTok'
  >;
}
...
export interface IntegrationsSliceDefaultPrimary {
  ...
  /**
   * nahbro field in *Integrations → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: integrations.default.primary.nahbro[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  nahbro: prismic.GroupField<
    Simplify<IntegrationsSliceDefaultPrimaryNahbroItem>
  >;
}
...
declare module '@prismicio/client' {
  ...
  namespace Content {
    export type {
      ...
      AllDocumentTypes,
      BentoSlice,
      BentoSliceDefaultPrimaryBox1Item,
      ...
      HeroSliceDefault,
      IntegrationsSlice,
      IntegrationsSliceDefaultPrimaryNahbroItem,
